...
// CODE HERE
const sayHelloBtn = document.getElementById('say-hello-button')
...
*/
const styler = (color1, color2) => {
sayHelloBtn.style.backgroundColor = color1
sayHelloBtn.style.color = color2
}
// CODE HERE
const colorBtn = () => {
styler('black', 'white')
}
 sayHelloBtn.addEventListener('mouseover', colorBtn )
...
const ohMy = () => {
    ...
    .then(res => {
       ...
       const pirntAnimal = document.createElement('p')
       pirntAnimal.textContent = animal
       document.querySelector('body').appendChild(pirntAnimal)
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/this-is-myparam')
    .then(res => {
...
// CODE HERE
const queryTest = () => {
    axios.get('http://localhost:3000/query-test/?user=chris')
